...
const articleMap: Record<string, { file: string; title: string }> = {
  ...
  'fees': {
    file: '26_先払い買取_手数料.md',
    title: '先払い買取の手数料はいくら？買取率との関係と隠れコストを解説'
  },
  '24hours': {
    file: '27_先払い買取_24時間.md',
    title: '先払い買取で24時間対応の業者まとめ｜深夜・早朝もOKの業者4選'
  },
  'weekend': {
    file: '28_先払い買取_土日.md',
    title: '先払い買取は土日祝も利用できる？休日対応の業者と注意点'
  },
  'amount': {
    file: '29_先払い買取_金額.md',
    title: '先払い買取でいくらもらえる？金額の決まり方と各社の上限額を解説'
  },
  'documents': {
    file: '30_先払い買取_必要書類.md',
    title: '先払い買取の必要書類一覧｜身分証明書・準備するものをわかりやすく解説'
  },
  'process': {
    file: '31_先払い買取_流れ.md',
    title: '先払い買取の利用の流れ｜申込みから入金までの手順を図解で解説'
  }
}
